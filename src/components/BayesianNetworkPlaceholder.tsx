export function BayesianNetworkPlaceholder() {
  return (
    <div className="card">
      ...
      <div
        ...
        className="flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-safer-grey/30"
